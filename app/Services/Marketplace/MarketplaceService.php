...
class MarketplaceService
{
    ...
    public function update($request, $log_service) {
        ...
        $log_message = $account -> code . ": " . $account -> title . " writing account successfully updated.";
        ...
        return $account -> code . ": " . $account -> title . " writing account successfully updated.";
    }    

    public function delete($request, $log_service) {
        Log::info($request -> toArray());
        $account = Account::find($request -> toArray()["id"]);
        $account -> delete();

        $log_message = $account -> code . ": " . $account -> title . " writing account successfully deleted.";
        ...
        return $account -> code . ":" . $account -> title . " writing account successfully deleted.";
    }
