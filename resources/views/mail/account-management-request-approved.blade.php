                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Thank you for giving us the opportunity to manage your account.
                                    Your account has been approved and is now being managed by us. 
                                    You will owe us {{ $pay_cut }}% of the total earnings of the account, payable on date {{ $payday }} of every month.
                                    We will be emailing you an invoice on the payday.
                                    If you have any questions, please feel free to contact us at.
                                </div>
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <a href="mailto:kazibin66@gmail.com"> Contact Us </a>
                                </div>
                            </div>
                        </div>
                    </div>
