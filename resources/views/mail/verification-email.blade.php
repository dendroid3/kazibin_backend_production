...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="text-lg leading-7 text-gray-600 dark:text-gray-400 font-semibold">
                                    <div class="flex justify-center pt-8 sm:justify-start sm:pt-0 icon">
                            ...
                            <div class="mt-12">
                                ...
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            Bid on tasks posted by brokers displayed on the "Available" page.
                                        </li>
                                    </ul>
                                </div>
                                
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    As a broker (employer) you can: 
                                    <ul>
                                        <li>
                                            Explore writers and liaise with them for long-term commitments.
                                        </li>
                                        <li>
                                            Offer tasks directly to a single or multiple writers that you have liaised with.
                                        </li>
                                        <li>
                                            Post tasks for writers to bid on from the platform.
                                        </li>
                                        <li>
                                            Advertise urgent orders to over 10000 writers on our telegram channel.
                                        </li>
                                        <li>
                                            Organise your jobs more efficiently by getting a chat for each individual task.
                                        </li>
                                    </ul>
                                </div>
                                ...
                                data-client-url="{{env('APP_CLIENT')}}"
                                data-email-verification-code="{{$user->email_verification}}"
        ...
        <script>
            let verification_button = document.getElementById('verification_button')
            verification_button.addEventListener('click', function(){
                const client_url = verification_button.getAttribute('data-client-url')
                const verification_code = verification_button.getAttribute('data-email-verification-code')
                const email = verification_button.getAttribute('data-email-address')

                let url =  client_url + '/verify_email/' + verification_code + '?email=' + email
